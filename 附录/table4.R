we_150 <- read.csv("C:/Users/Administrator/Documents/Statistics/待议论文/cure/GOF/GOF for Turnbull/tttttry/150/alpha0.3phi0.8(2021)/we.csv",header = F)
go_150 <- read.csv("C:/Users/Administrator/Documents/Statistics/待议论文/cure/GOF/GOF for Turnbull/tttttry/150/alpha0.3phi0.8(2021)/go.csv",header = F)
lo_150 <- read.csv("C:/Users/Administrator/Documents/Statistics/待议论文/cure/GOF/GOF for Turnbull/tttttry/150/alpha0.3phi0.8(2021)/lo.csv",header = F)
un_150 <- read.csv("C:/Users/Administrator/Documents/Statistics/待议论文/cure/GOF/GOF for Turnbull/tttttry/150/alpha0.3phi0.8(2021)/un.csv",header = F)
...
un_500 <- read.csv("C:/Users/Administrator/Documents/Statistics/待议论文/cure/GOF/GOF for Turnbull/tttttry/500/alpha0.3phi0.8(2021)/un.csv",header = F)
